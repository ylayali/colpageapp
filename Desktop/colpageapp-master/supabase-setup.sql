...
CREATE TABLE IF NOT EXISTS public.users (
    ...
    subscription_tier TEXT CHECK (subscription_tier IN ('basic', 'standard', 'premium')) NULL,
    subscription_expires_at TIMESTAMP WITH TIME ZONE NULL,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL,
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW() NOT NULL
);

-- Add subscription_tier column to existing tables (if they exist)
ALTER TABLE public.users ADD COLUMN IF NOT EXISTS subscription_tier TEXT CHECK (subscription_tier IN ('basic', 'standard', 'premium'));
