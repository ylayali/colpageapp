...
export default function HomePage() {
    ...
    // Temporary mock credits - will be replaced with real user management
    const [userCredits, setUserCredits] = React.useState(3);
    ...
    const handleApiCall = async (formData: ColoringFormData) => {
        ...
        if (formData.coloringPageType === 'cartoon_portrait' && formData.source_images && formData.source_images.length > 0) {
        ...
        if (formData.coloringPageType === 'cartoon_portrait' && formData.source_images) {
